import {ADD_RESERVATION, DELETE_RESERVATION,UPDATE_RESERVATION, DELETE_ALL_RESERVATION,CONFIRMATION_RESERVATION} from './ReservationActionsTypes'
...
export const CONFIRM_RESERVATION=(user)=>{
    return {type:CONFIRMATION_RESERVATION, payload:user}
}